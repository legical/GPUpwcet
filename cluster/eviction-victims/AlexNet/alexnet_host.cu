...
void NeuralNetwork()
{
	...
	void* saddr;
	cudaMalloc((void**) &saddr, sizeof(float)* (INPUT_SIZE+  L1_KERNEL_SIZE * L1_OUT+ L1_OUT+L1_OUT * L1_FMAP
											   +L1_OUT*L1_FMAP + L1_OUT * POOL1_FMAP + L2_KERNEL_SIZE * L2_OUT
											   +L2_OUT+ L2_OUT * L2_FMAP + L2_OUT * L2_FMAP+ L2_OUT * POOL2_FMAP
											   +L3_KERNEL_SIZE * L3_OUT+ L3_OUT + L3_OUT*L3_FMAP
											   +L4_KERNEL_SIZE * L4_OUT + L4_OUT + L4_OUT*L4_FMAP
											   +L5_KERNEL_SIZE * L5_OUT + L5_OUT + L5_OUT*L5_FMAP
											   +L5_OUT * POOL3_FMAP + 4096*256*6*6+4096+4096
											   + 4096*4096+ 4096+4096 + 4096*1000+1000+1000));

	// cudaMalloc((void**) &Layer1_Neurons_GPU, sizeof(float)* INPUT_SIZE);
	Layer1_Neurons_GPU = (float*)((void*)saddr);
	// cudaMalloc((void**) &Layer1_Weights_GPU, sizeof(float)* L1_KERNEL_SIZE * L1_OUT);
	Layer1_Weights_GPU = (float*)((void*)Layer1_Neurons_GPU + sizeof(float)*INPUT_SIZE);
	// cudaMalloc((void**) &Layer1_bias_GPU, sizeof(float)* L1_OUT);
	Layer1_bias_GPU = (float*)((void*)Layer1_Weights_GPU + sizeof(float)*L1_KERNEL_SIZE * L1_OUT);
	// cudaMalloc((void**) &Layer1_Norm_GPU, sizeof(float)* (L1_OUT * L1_FMAP));
	Layer1_Norm_GPU = (float*)((void*)Layer1_bias_GPU + sizeof(float)*L1_OUT);
	...
	Layer1_pool_GPU = (float*)((void*)Layer1_Norm_GPU + sizeof(float)*(L1_OUT * L1_FMAP));
	...
	Layer2_Neurons_GPU = (float*)((void*)Layer1_pool_GPU + sizeof(float)*(L1_OUT*L1_FMAP));
	...
	Layer2_Weights_GPU = (float*)((void*)Layer2_Neurons_GPU + sizeof(float)*(L1_OUT * POOL1_FMAP));
	// cudaMalloc((void**) &Layer2_bias_GPU, sizeof(float)* L2_OUT);
	Layer2_bias_GPU = (float*)((void*)Layer2_Weights_GPU + sizeof(float)*(L2_KERNEL_SIZE * L2_OUT));
	// cudaMalloc((void**) &Layer2_Norm_GPU, sizeof(float)* L2_OUT * L2_FMAP);
	Layer2_Norm_GPU = (float*)((void*)Layer2_bias_GPU + sizeof(float)*L2_OUT);
	...
	Layer2_pool_GPU = (float*)((void*)Layer2_Norm_GPU + sizeof(float)*L2_OUT * L2_FMAP);
	...
	Layer3_Neurons_GPU = (float*)((void*)Layer2_pool_GPU + sizeof(float)*L2_OUT * L2_FMAP);
	...
	Layer3_Weights_GPU = (float*)((void*)Layer3_Neurons_GPU + sizeof(float)*L2_OUT * POOL2_FMAP);
	// cudaMalloc((void**) &Layer3_bias_GPU, sizeof(float)*L3_OUT);
	Layer3_bias_GPU = (float*)((void*)Layer3_Weights_GPU + sizeof(float)*L3_KERNEL_SIZE * L3_OUT);
	// cudaMalloc((void**) &Layer4_Neurons_GPU, sizeof(float)*(L3_FMAP * L3_OUT));
	Layer4_Neurons_GPU = (float*)((void*)Layer3_bias_GPU + sizeof(float)*L3_OUT);
	...
	Layer4_Weights_GPU = (float*)((void*)Layer4_Neurons_GPU + sizeof(float)*L3_FMAP * L3_OUT);
	// cudaMalloc((void**) &Layer4_bias_GPU, sizeof(float)*L4_OUT);
	Layer4_bias_GPU = (float*)((void*)Layer4_Weights_GPU + sizeof(float)*L4_KERNEL_SIZE * L4_OUT);
	// cudaMalloc((void**) &Layer5_Neurons_GPU, sizeof(float)*(L4_FMAP * L4_OUT));
	Layer5_Neurons_GPU = (float*)((void*)Layer4_bias_GPU + sizeof(float)*L4_OUT);
	...
	Layer5_Weights_GPU = (float*)((void*)Layer5_Neurons_GPU + sizeof(float)*L4_FMAP * L4_OUT);
	// cudaMalloc((void**) &Layer5_bias_GPU, sizeof(float)*L5_OUT);
	Layer5_bias_GPU = (float*)((void*)Layer5_Weights_GPU + sizeof(float)*L5_KERNEL_SIZE * L5_OUT);
	// cudaMalloc((void**) &Layer5_pool_GPU, sizeof(float)*(L5_FMAP * L5_OUT));
	Layer5_pool_GPU = (float*)((void*)Layer5_bias_GPU + sizeof(float)*L5_OUT);
	...
	Layer6_Neurons_GPU = (float*)((void*)Layer5_pool_GPU + sizeof(float)*L5_FMAP * L5_OUT);
	...
	Layer6_Weights_GPU = (float*)((void*)Layer6_Neurons_GPU + sizeof(float)*L5_OUT * POOL3_FMAP);
	// cudaMalloc((void**) &Layer6_bias_GPU, sizeof(float)*4096);
	Layer6_bias_GPU = (float*)((void*)Layer6_Weights_GPU + sizeof(float)*4096*256*6*6);
	// cudaMalloc((void**) &Layer7_Neurons_GPU, sizeof(float)*4096);
	Layer7_Neurons_GPU = (float*)((void*)Layer6_bias_GPU + sizeof(float)*4096);
	...
	Layer7_Weights_GPU = (float*)((void*)Layer7_Neurons_GPU + sizeof(float)*4096);
	// cudaMalloc((void**) &Layer7_bias_GPU, sizeof(float)*4096);
	Layer7_bias_GPU = (float*)((void*)Layer7_Weights_GPU + sizeof(float)*4096*4096);
	// cudaMalloc((void**) &Layer8_Neurons_GPU, sizeof(float)*4096);
	Layer8_Neurons_GPU = (float*)((void*)Layer7_bias_GPU + sizeof(float)*4096);
	...
	Layer8_Weights_GPU = (float*)((void*)Layer8_Neurons_GPU + sizeof(float)*4096);
	// cudaMalloc((void**) &Layer8_bias_GPU, sizeof(float)*1000);
	Layer8_bias_GPU = (float*)((void*)Layer8_Weights_GPU + sizeof(float)*4096*1000);
	// cudaMalloc((void**) &Layer9_Neurons_GPU, sizeof(float)*1000);
	Layer9_Neurons_GPU = (float*)((void*)Layer8_bias_GPU + sizeof(float)*1000);
